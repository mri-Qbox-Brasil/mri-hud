// Contrato compartilhado entre mri_Qadmin (host) e plugins guest (mri-hud,
// mri_Qspawn, futuros). Drift control: este arquivo deve bater 1:1 com a copia
// em mri_Qadmin/web/src/plugin/types.ts. Mudancas aqui sao breaking pro
