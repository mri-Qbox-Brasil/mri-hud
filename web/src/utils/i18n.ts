...
const defaultTranslations: Translation = {
  ...
  vehicleThemeLabel: "Vehicle HUD Theme",
  vehicleThemeClassic: "Classic",
  vehicleThemeDigital: "Digital",
  vehicleThemeDescription: "Switch between the classic analog speedometer and the digital cluster",
  vehicleThemeAdminOnly: "Only admins can change the vehicle HUD theme",
  vehicleSpeedoVariantLabel: "Speedometer Format",
  vehicleSpeedoVariantDescription: "Format of the digital speedometer: ring, arc or linear",
  playerSkinLabel: "Player HUD Skin",
  playerSkinClassic: "Classic",
  playerSkinSupernatural: "Supernatural",
  playerSkinDescription: "Switch between the classic player HUD and the supernatural skin (vitals, money, server)",
  playerSkinAdminOnly: "Only admins can change the player HUD skin",
  skinPaletteLabel: "Palette",
  skinStyleLabel: "Vitals Style",
  skinLayoutLabel: "Layout",
  skinFramelessLabel: "Remove backgrounds (orbs + money)",
