    ...
    return (
        <>
            <DraggableHudElement id="aircraftHorizon" label="Horizonte" zIndex={15}>
                <ScaledHudContent style={{ position: "fixed", top: "5vh", right: "22vw", pointerEvents: "none" }}>
                    <ArtificialHorizon size={160} pitch={pitch} roll={roll} />
                </ScaledHudContent>
            </DraggableHudElement>

            <DraggableHudElement id="aircraftAsi" label="Velocidade" zIndex={15}>
                <ScaledHudContent style={{ position: "fixed", top: "5vh", right: "15vw", pointerEvents: "none" }}>
                    <AnalogGauge
                        size={120}
                        value={airspeed}
                        minValue={0}
            ...
            <DraggableHudElement id="aircraftAlt" label="Altímetro" zIndex={15}>
                <ScaledHudContent style={{ position: "fixed", top: "5vh", right: "8vw", pointerEvents: "none" }}>
                    <AnalogGauge
                        size={120}
                        value={altMod}
                        minValue={0}
            ...
            <DraggableHudElement id="aircraftVsi" label="Vel.Vertical" zIndex={15}>
                <ScaledHudContent style={{ position: "fixed", top: "5vh", right: "2vw", pointerEvents: "none" }}>
                    <AnalogGauge
                        size={100}
                        value={verticalSpeed}
                        minValue={-30}
