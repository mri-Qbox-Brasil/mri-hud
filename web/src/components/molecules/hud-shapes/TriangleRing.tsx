...
const TRI_PATH = "M21.87,19.29,13.13,4.14a1.29,1.29,0,0,0-2.26,0L2.13,19.29a1.27,1.27,0,0,0,1.13,1.86H20.74A1.27,1.27,0,0,0,21.87,19.29Z";

export default function TriangleRing({
  displayOutline = true,
  height = 50,
  width = 50,
  icon = null,
